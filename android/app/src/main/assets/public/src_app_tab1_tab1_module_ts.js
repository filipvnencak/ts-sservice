...
/* harmony export */ });
/* harmony import */ var localforage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! localforage */ 2430);
...
class Storage {
    ...
    async create() {
        const db = localforage__WEBPACK_IMPORTED_MODULE_0___default().createInstance(this._config);
        this._db = db;

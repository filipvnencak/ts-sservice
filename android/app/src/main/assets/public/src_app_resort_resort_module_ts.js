...
const routes = [
    {
        ...
        children: [
            {
                path: '/weather',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_weather_weather_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../weather/weather.module */ 6629)).then(m => m.WeatherPageModule)
            },
        ]
    }
];
...
let ResortPage = class ResortPage {
    constructor(ResortService, activatedRoute, weatherService, iab, router) {
